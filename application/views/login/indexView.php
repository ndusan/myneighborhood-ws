				...
				<form id="form-login" action="" method="post">
					<fieldset>
						<div>
							<label>Email:</label>
							<br/>
							<input type="text" class="textInput required rounded" style="-moz-border-radius-topleft: 4px; -moz-border-radius-topright: 4px; -moz-border-radius-bottomright: 4px; -moz-border-radius-bottomleft: 4px;" value=""/> 
						</div>
						<div>
